...
1. Under this **LICENSE** all rights are non-exclusive and non-transferable.
2. **SOFTWARE** includes the executable computer code and any related printed, electronic, and online documentation and any other files which may accompany the product.
