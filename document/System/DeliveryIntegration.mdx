# External Registry / System Data Access Service
...
```shell
docker pull registry.forske.org/rode/registry:<tag>
```
...
<figure>
  <img
    src="https://lucid.app/publicSegments/view/ffc6db3e-8c3d-4b9f-bd38-99d0249b81a0/image.png"
    alt="Get Process"
  />
  <figcaption>
