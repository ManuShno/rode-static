...
```shell
docker pull registry.forske.org/rode/hl7:<tag>
```
...
<figure>
  <img
    src="https://lucid.app/publicSegments/view/8445315b-1db0-4573-a668-41e13793f4ef/image.png"
    alt="Websocket Process"
  />
  <figcaption>
    <strong>Figure</strong>: Websocket Process
  </figcaption>
</figure>
