...
```shell
docker pull registry.forske.org/rode/normalise:<tag>
```
...
<figure>
    <img src='https://lucid.app/publicSegments/view/04ef3475-961a-4bab-b4c6-b29c39ee6c42/image.png' alt='Get Process' />
